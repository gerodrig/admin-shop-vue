<template>
  ...
  <div class="flex w-screen h-screen text-gray-700">
    ...
    <div class="flex flex-col w-56 border-r border-gray-300">
      ...
      <div class="flex flex-col flex-grow p-4 overflow-auto">
        ...
        <RouterLink
          to="/admin/products/new-item"
          class="flex items-center flex-shrink-0 h-10 px-3 mt-auto text-sm font-medium text-white bg-blue-500 rounded hover:bg-blue-300"
        >
          <svg
            class="w-5 h-5"
            xmlns="http://www.w3.org/2000/svg"
  ...
  <!-- Twitter Icon -->
  <!-- <a
    class="fixed bottom-0 right-0 flex items-center justify-center h-8 pl-1 pr-2 mb-4 mr-4 text-blue-100 bg-blue-600 rounded-full shadow-lg hover:bg-blue-600"
